...
import { AdminEventsFormPage } from "./pages/admin/admin-events-form-page";
...
export const router = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      ...
      { path: "events/:id/edit", Component: AdminEventsFormPage},
      { path: "events/create", Component: AdminEventsFormPage},
    ],
  },
  {
    path: "*",
