...
/**
 * Handler sau khi OAuth2 login thành công.
 * <p>
 * Redirect về frontend SPA kèm accessToken và refreshToken
 * dưới dạng query params để frontend lưu vào localStorage.
 * </p>
 */
@Component
public class OAuth2LoginSuccessHandler implements AuthenticationSuccessHandler {
    ...
    public void onAuthenticationSuccess(
        ...
        // Fallback nếu không lấy được token
